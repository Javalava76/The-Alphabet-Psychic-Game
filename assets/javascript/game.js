...
// by comparing it to "guessesSoFar" array and comparing against the "alphabetLetters" array
	...
	var html = "<h1>The Psychic Game</h1>" + "<h3>Guess what letter I'm thinking of...</h3>" + "<h3>Wins: " + wins + "</h3>" + "<h3>Losses: " + losses + "</h3>" + "<h3>Guesses Left: " + guessesLeft + "</h3>" + "<h3>Your guesses so far: " + guessesSoFar.join(', ') + "</h3>";
